...
//
//
//    public String getElementByIdJSExecutor(String id) {
//        return ((JavascriptExecutor) webDriver).executeScript("return window.getComputedStyle(document.getElementsById('" + id + "')").toString();
//    }
//    /**
